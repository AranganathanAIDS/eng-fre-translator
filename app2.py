...
with open(r"D:\Final project\eng_tokenizer.pkl", 'rb') as f:
    eng_tok = pickle.load(f)
with open(r"D:\Final project\fr_tokenizer.pkl", 'rb') as f:
    fr_tok = pickle.load(f)

gen_encoder = load_model(r"D:\Final project\encoder_model.h5")
gen_decoder = load_model(r"D:\Final project\decoder_model.h5")
